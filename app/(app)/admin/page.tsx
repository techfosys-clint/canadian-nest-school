    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center p-6">
        <div className="text-center space-y-4 max-w-md bg-white border border-slate-200 p-6 rounded-lg shadow-sm">
          ...
          <h2 className="text-lg font-bold text-slate-800">Dashboard Load Error</h2>
          ...
          <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-auto select-none overflow-visible">
            ...
            {points.map((p, i) => (
              <g key={i}>
                ...
                <text x={p.x} y={height - 4} fill="#94a3b8" fontSize="11" fontWeight="semibold" textAnchor="middle">
                  {p.label}
                </text>
              </g>
            ))}
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-base font-semibold text-slate-500">Net Revenue</p>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-base font-semibold text-slate-500">Pending Reviews</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 bg-white border border-slate-200 rounded-lg p-5 shadow-sm space-y-5">
              <div>
                <h2 className="text-lg font-bold text-slate-800">Operational Shortcuts</h2>
                <p className="text-base font-semibold text-slate-500 mt-0.5">Quick management routing</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            {/* Recent Sales (8 cols) */}
            <div id="enrollments" className="lg:col-span-8 bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden scroll-mt-24">
                      ...
                      {((searchResults !== null ? searchResults : recentEnrollments) || []).map((e) => (
                        <tr key={e.id} className="hover:bg-slate-50 transition-colors">
                          <td className="px-6 py-4">
                            ...
                            <p className="text-base font-semibold text-slate-400 mt-0.5">{e.studentEmail}</p>
                          </td>
            ...
            <div className="lg:col-span-4 bg-white border border-slate-200 rounded-lg shadow-sm flex flex-col">
              <div className="px-6 py-5 border-b border-slate-100">
                <h2 className="text-lg font-bold text-slate-800">Reviews Pending</h2>
                <p className="text-base font-semibold text-slate-500 mt-0.5">Testimonial moderation feed</p>
              </div>
              ...
              <div className="flex-1 divide-y divide-slate-100 overflow-y-auto max-h-[360px]">
                {recentReviews && recentReviews.length === 0 ? (
                  ...
                  recentReviews?.map((r) => (
                    <div key={r.id} className="p-5 space-y-3.5 hover:bg-slate-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <div>
      ...
      {role === 'staff' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-base font-semibold text-slate-500">Categories</p>
              <p className="text-2xl font-bold text-slate-800">{summary.totalCategories || 0}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-base font-semibold text-slate-500">Blog Posts</p>
              <p className="text-2xl font-bold text-slate-800">{summary.totalBlogs || 0}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-base font-semibold text-slate-500"> accordion FAQs</p>
              <p className="text-2xl font-bold text-slate-800">{summary.totalFAQs || 0}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-base font-semibold text-slate-500">Pending Reviews</p>
              <p className="text-2xl font-bold text-slate-800">{summary.pendingReviews || 0}</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div className="bg-white border border-slate-200 p-6 rounded-lg shadow-sm flex items-center gap-4">
              ...
              <div>
                <p className="text-base font-semibold text-slate-500">Assigned Courses</p>
                <p className="text-2xl font-bold text-slate-800">{summary.totalCourses || 0}</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-lg shadow-sm flex items-center gap-4">
              ...
              <div>
                <p className="text-base font-semibold text-slate-500">Lessons Created</p>
                <p className="text-2xl font-bold text-slate-800">{summary.totalLessons || 0}</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-lg shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-800">{summary.totalStudents || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-white border border-slate-200 rounded-lg p-6 shadow-sm space-y-4">
              <div>
                <h2 className="text-lg font-bold text-slate-800">Your Syllabus</h2>
                <p className="text-base font-semibold text-slate-500 mt-0.5">Courses currently assigned to your instruction</p>
              </div>
                        ...
                        <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-bold text-slate-800 text-base leading-snug line-clamp-1">{c.title}</p>
                      ...
                      <div key={lesson.id} className="pt-4 first:pt-0 flex flex-col gap-2">
                        <div>
                          <div className="flex items-start justify-between gap-2">
                            <h3 className="font-bold text-slate-800 text-base leading-snug line-clamp-2">{lesson.title}</h3>
                          ...
                          <p className="text-xs font-bold text-slate-400 mt-1 truncate">{lesson.courseTitle}</p>
                        </div>

                        <div className="flex items-center justify-between gap-3 bg-slate-50 border border-slate-200 p-2 rounded-lg">
                          <div className="flex items-center gap-1.5">
                            <span className={`h-2 w-2 rounded-full ${isUpcoming ? 'bg-amber-400 animate-pulse' : 'bg-slate-300'}`} />
                          ...
                          {lesson.liveUrl ? (
                            ...
                            <span className="text-xs font-bold text-slate-400 shrink-0">Pending</span>
                          )}
                        </div>
                      </div>
                    )
