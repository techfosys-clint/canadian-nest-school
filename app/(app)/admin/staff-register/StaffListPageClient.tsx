        ...
        {filteredStaff.length === 0 ? (
          <div className='text-center py-16 space-y-2'>
            ...
            <p className='text-base font-semibold text-slate-500'>
              No faculty or staff members match the query.
            </p>
          </div>
        ) : (
              ...
              <tbody className='divide-y divide-slate-100 font-semibold text-slate-600'>
                {filteredStaff.map((member) => (
                  ...
                  >
                    ...
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          {member.designation && (
                            <p className='text-[#E61C24] text-xs font-bold mt-1 tracking-wide'>
                              {member.designation}
                            </p>
                          )}
                    ...
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <span
                        className={`inline-flex px-2.5 py-1 rounded text-xs font-bold capitalize select-none ${
                          member.role === 'admin'
                    ...
                    <td className='px-6 py-4 whitespace-nowrap text-right space-x-1.5 min-w-[140px]'>
                      {confirmDeleteId === member.id ? (
                        <div className='inline-flex items-center gap-1.5 bg-rose-50 p-1 rounded-lg border border-rose-200'>
                          <span className='text-xs font-bold text-rose-500 px-1'>
                            Confirm?
                          </span>
                          <button
                            onClick={() =>
                              executeDeleteStaff(member.id, member.name)
                            }
                        ...
                        <>
                          <button
                            onClick={() =>
                              router.push(
                                `/admin/staff-register/${member.id}/edit`,
                              )
                            }
