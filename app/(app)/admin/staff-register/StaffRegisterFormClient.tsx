...
export default function StaffRegisterFormClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(
        `/admin/staff-register?success=registered&emailSent=${data.emailSent !== false}`,
      );
      router.refresh();
    } catch (err: any) {
    ...
    <div className='w-full bg-white border border-slate-200 rounded-lg p-6 md:p-8 shadow-xl space-y-6 select-text'>
      ...
      <div className='flex items-center justify-between pb-4 border-b border-slate-200/60'>
        <div className='flex items-center gap-3'>
          <div className='h-10 w-10 rounded-lg bg-[#E61C24]/15 flex items-center justify-center'>
            <FiUserPlus className='text-[#E61C24] h-5.5 w-5.5' />
          </div>
          <div>
            ...
            <p className='text-sm font-semibold text-slate-500 mt-1.5'>
              Register a new administrative or teacher account
            </p>
          </div>
        </div>
        <button
      ...
      <form onSubmit={handleSubmit} className='space-y-6 text-base font-sans'>
        ...
        <div className='space-y-5'>
            ...
            <div className='flex flex-col gap-1.5'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='w-full bg-slate-100 border-none focus:ring-2 focus:ring-[#E61C24]/40 text-slate-800 rounded-lg pl-11 pr-4 py-3.5 text-base font-semibold outline-none transition-all shadow-sm'
                />
              </div>
            </div>
          ...
          <div className='flex flex-col gap-1.5 pt-2'>
            <label className='text-base font-bold text-slate-600'>
              Staff Job Designation / Professional Role (Optional)
            </label>
            <div className='relative'>
              <FiUser className='absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 h-5 w-5' />
              <input
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
              ...
              <label
                ...
                className={`flex items-start gap-3 p-4 rounded-lg border-none cursor-pointer transition-all duration-200 select-none ${
                  role === 'staff'
                    ? 'bg-[#E61C24]/10 text-slate-800 shadow-md'
              ...
              >
                ...
                />
                <FiShield
                  className={`h-5 w-5 shrink-0 mt-0.5 ${role === 'staff' ? 'text-[#a5b4fc]' : 'text-slate-400'}`}
                />
              ...
              >
                ...
                />
                <FiShield
                  className={`h-5 w-5 shrink-0 mt-0.5 ${role === 'instructor' ? 'text-[#a5b4fc]' : 'text-slate-400'}`}
                />
                <div className='text-left'>
              ...
              >
                ...
                />
                <FiShield
                  className={`h-5 w-5 shrink-0 mt-0.5 ${role === 'admin' ? 'text-[#a5b4fc]' : 'text-slate-400'}`}
                />
                <div className='text-left'>
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        className='h-4.5 w-4.5 rounded border-none text-[#E61C24] focus:ring-0 cursor-pointer'
                      />
        ...
        <div className='pt-4'>
          <button
            type='submit'
            disabled={loading}
            className='w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-[#E61C24] hover:bg-[#CC181F] text-white font-bold text-base transition-all duration-200 cursor-pointer disabled:opacity-50 border-none shadow-md'
          >
