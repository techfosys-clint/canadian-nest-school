    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">User Database</h1>
            <p className="text-sm font-semibold text-slate-500 mt-1">Manage platform students, instructors, and staff.</p>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <span className="text-sm font-bold text-slate-500">Loading database...</span>
                    </div>
                  </td>
                </tr>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-bold text-slate-900 group-hover:text-[#E61C24] transition-colors">{user.name}</p>
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${
                        ...
                        {user.isSuperAdmin ? <FiShield className="mr-1 h-3 w-3" /> : null}
                        {user.role}
                      </span>
                    </td>
                    <td className="px-6 py-4">
