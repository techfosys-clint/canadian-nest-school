    ...
    <div className='w-full'>
      ...
      <section className='w-full bg-[#f8fafc] border-b border-zinc-200/80 py-16 relative overflow-hidden'>
        ...
        >
          ...
          >
            Explore English language learning guides, teaching methods,
            classroom activities, and educational updates curated by our expert
            instructors.
          </motion.p>
          ...
          <AnimatePresence mode='popLayout'>
            {filteredBlogs.length > 0 ? (
              ...
              >
                ...
                <h3 className='text-lg font-bold text-zinc-850'>
                  No Results Found
                </h3>
                <p className='text-zinc-550 text-base font-medium mt-1'>
