        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16'>
          <div className='space-y-4 max-w-2xl'>
            ...
            <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-[#0A163A] tracking-tight leading-[1.2]'>
              The Canadian Nest{' '}
              <span className='text-[#E61C24]'>Knowledge Hub</span>
            </h2>

            {/* Description */}
            <p className='text-base md:text-lg font-semibold text-[#4F5B7C] leading-relaxed'>
              Read our latest articles, parenting tips, and expert advice on how
              to improve English pronunciation, phonics, and communication
              skills easily.
            </p>
          </div>
              ...
              >
                <div>
                  ...
                  <p className='text-base font-medium text-[#4b5563] line-clamp-2 leading-relaxed mb-5'>
                    {previewText ||
                      'Dive into this article to learn more about this topic.'}
                  </p>
                </div>
                ...
                <div className='flex items-center gap-2.5 text-sm font-semibold text-[#4b5563]/80 mt-1'>
                  ...
                  <span className='text-[#0A163A] font-bold'>
                    {blog.authorName}
                  </span>
