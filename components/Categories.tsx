  ...
  return (
    <section className='py-20 md:py-28 px-6 bg-[#f9fafb] border-t border-zinc-100 relative overflow-hidden'>
      <style jsx>{`
        ...
        .float-d {
          animation: floatY 10s ease-in-out infinite 4.5s;
        }
      `}</style>
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(#E61C24 0.5px, transparent 0.5px)',
      ...
      <div className='container mx-auto relative z-10'>
        ...
        <div className='text-center mb-8 space-y-4 relative z-30 py-2'>
          ...
          >
            Explore Our{' '}
            <span className='text-[#E61C24]'>Specialized English Programs</span>
          </motion.h2>
          ...
          >
            From foundational Phonics for kids to advanced Spoken English, IELTS
            preparation, and professional Teacher Training, choose the perfect
            program tailored to your learning goals.
          </motion.p>
        </div>
          ...
          {CARDS_DATA.map((card, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white border-2 ${card.borderColor} rounded-lg shadow-xs flex items-center justify-center transition-all duration-500 scale-110 group-hover:scale-115 z-20 w-12 h-12`}
                >
                  ...
                  <div
                    className={`absolute inset-0 flex items-center justify-center transition-all duration-500 ease-out opacity-0 scale-50 -rotate-45 group-hover:opacity-100 group-hover:scale-100 group-hover:rotate-0 ${card.iconColor}`}
                  >
                ...
                <div className='flex flex-col justify-between h-full pt-4 space-y-2.5'>
                  ...
                  <p className='text-base text-zinc-500 font-semibold leading-relaxed grow'>
                    {card.description}
                  </p>
                </div>
              </Link>
