    ...
    >
      ...
      <div className='container mx-auto relative z-10'>
        ...
        <div className='text-center mb-12' ref={headRef}>
          ...
          >
            Our Most Favourite{' '}
            <span className='text-[#E61C24]'>English Programs</span>
          </motion.h2>
        </div>
                ...
                >
                  <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-center'>
                    ...
                    <div className='lg:col-span-6 relative aspect-16/10 bg-[#f9fafb] rounded-lg overflow-hidden border border-zinc-100'>
                      {getImageUrl(featuredCourse.thumbnail) ? (
                        <Image
                          ...
                          onError={(e) => {
                            ...
                            if (parent) {
                              const fallback =
                                parent.querySelector('.css-placeholder');
                      ...
                      <div
                        className={`css-placeholder w-full h-full bg-linear-to-br from-[#0A163A] to-[#121212] flex flex-col items-center justify-center border border-white/5 absolute inset-0 ${getImageUrl(featuredCourse.thumbnail) ? 'hidden' : ''}`}
                      >
                      ...
                      <div className='space-y-4'>
                        ...
                        <div className='flex flex-wrap items-center gap-2'>
                          <span className='px-3.5 py-1.5 bg-[#E61C24]/8 text-[#E61C24] rounded-lg font-bold text-base border border-[#E61C24]/15'>
                            {getCategoryName(featuredCourse.category) ||
                              'Course'}
                          </span>
                        ...
                        <div className='flex flex-wrap items-center gap-5 pt-2 border-b border-zinc-100 pb-4 text-base font-bold text-[#4b5563]'>
                          ...
                          {(featuredCourse.enrollmentCount ?? 0) > 0 && (
                            <span className='flex items-center gap-2'>
                              ...
                              <span>
                                {featuredCourse.enrollmentCount} students
                              </span>
                            </span>
                          )}
                          {(featuredCourse.avgRating ?? 0) > 0 && (
                            <span className='flex items-center gap-1.5'>
                              ...
                              <span className='text-zinc-700'>
                                {featuredCourse.avgRating}
                              </span>
                              {(featuredCourse.reviewCount ?? 0) > 0 && (
                                <span className='text-zinc-400 font-semibold'>
                                  ({featuredCourse.reviewCount})
                                </span>
                              )}
                            </span>
                          )}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className='relative aspect-16/10 bg-[#f9fafb] overflow-hidden rounded-t-lg'>
                          ...
                          <div
                            className={`css-placeholder w-full h-full bg-linear-to-br from-[#0A163A] to-[#121212] flex flex-col items-center justify-center border border-white/5 absolute inset-0 ${getImageUrl(course.thumbnail) ? 'hidden' : ''} rounded-t-lg`}
                          >
