    ...
    <section id='features' className='py-20 md:py-28 bg-[#FFFFFF] select-text'>
      <div className='container mx-auto px-6'>
        ...
        <div className='text-center max-w-3xl mx-auto mb-16 md:mb-20'>
          ...
          >
            Experience the{' '}
            <span className='text-[#E61C24]'>
              International Way of Learning
            </span>
          </motion.h2>
          ...
          >
            Watch how our expert instructors use practical and interactive
            methods to make English reading, speaking, and pronunciation
            effortless for every student.
          </motion.p>
        </div>
          ...
          <div className='flex flex-col gap-6'>
            {featuresList.map((item, idx) => (
              ...
              >
                ...
                <div
                  className={`shrink-0 w-12 h-12 rounded-full ${item.iconBg} ${item.iconColor} border ${item.iconBorder} flex items-center justify-center transition-transform duration-300 group-hover:scale-110`}
                >
                  {item.icon}
                </div>
