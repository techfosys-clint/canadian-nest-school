...
export default function Hero({ children }: { children?: React.ReactNode }) {
  return (
    <section className='w-full min-h-[96vh] relative flex flex-col justify-between pt-36 md:pt-44 overflow-hidden'>
      ...
      <div className='container mx-auto px-6 grow flex flex-col items-center justify-center relative z-10 pb-12 pt-8 md:pt-12'>
        ...
        >
          ...
          {
            'Empowering learners and educators to communicate with absolute confidence.'
          }
        </motion.p>
      ...
      <div className='w-full relative z-20 pb-4'>{children}</div>
    </section>
  );
}
