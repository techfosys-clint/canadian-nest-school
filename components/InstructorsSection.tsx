...
function AvatarFallback({ name }: { name: string }) {
  const initials = name
    ...
    .toUpperCase();
  return (
    <div className='w-full h-full flex items-center justify-center bg-linear-to-br from-[#E61C24]/20 to-[#E61C24]/5 text-[#E61C24] font-bold text-3xl'>
      {initials}
    </div>
  );
}
        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16'>
          <div className='space-y-4 max-w-2xl'>
            ...
            <p className='text-base text-[#94A3B8] leading-relaxed font-normal'>
              Our world-class instructors bring real-world experience and deep
              expertise to help you master your craft and advance your career.
            </p>
          </div>
          ...
          {instructors.map((instructor) => (
            ...
            >
              ...
              <div className='p-5'>
                ...
                {/* Role label */}
                <p className='text-sm text-[#A5B4FC] font-semibold mb-4'>
                  Instructor
                </p>
