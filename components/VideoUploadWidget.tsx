...
import { FiAlertCircle, FiCheck, FiCopy, FiUpload } from 'react-icons/fi';
...
export default function VideoUploadWidget({
  ...
  return (
    <div className='space-y-4'>
      <div
        className='border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-[#E61C24] transition-colors cursor-pointer'
